...
class Attributes_model extends CI_Model 
{
	...
	*/
	public function getAttribute($attribute_id)
        ...
        */
        ...
        /**
        * 
        * @function name : getTotalAttributeByGroupId()
        * @description   : get attribute record by role_id
        * @access        : public
        * @param   	 : int $attribute_group_id The attribute group id that you want
        * @return        : int total no of records
        *
        */
        public function getTotalAttributeByGroupId($attribute_group_id) 
        {
            $sql = "SELECT COUNT(*) AS total FROM attribute WHERE attribute_group_id = $attribute_group_id";
	...
	*/
	...
	{
		$sql = "SELECT *, (SELECT ag.attribute_group_name FROM attribute_group ag WHERE ag.attribute_group_id = a.attribute_group_id) AS attribute_group FROM attribute a";
		...
		if (isset($data['sort']) && in_array($data['sort'], $sort_data)) {
			...
			$sql .= " ORDER BY attribute_group, a.attribute_name";
		}
	...
	*/
	public function getTotalAttributes() 
	{
        ...
        public function getAttributesById($attribute_id) {

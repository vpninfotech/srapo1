...
class Sales_return_model extends CI_Model 
{
    ...
    */
	...
	{		
		...
		/*echo 'purchase_id:'.$this->input->post('purchase_id').'|';
		echo 'order_id:'.$this->input->post('purchase_order_id').'|';
		echo 'purchase_product_id:'.$this->input->post('purchase_product_id');	
		exit;*/
		//get product details
		$product_id=$this->input->post('product_id');
		$product_data=$this->product->getProductById($product_id);
	...
	/**
	* 
	* @function name 	: getTotalSalesReturn()
	...
	*/
	public function getSalesReturns($data = array())
	{
		...
		$sql = "SELECT * FROM purchase_return a WHERE manufacturer_id = '".(int)$this->session->userdata('manufacturer_user_id')."'";
	...
	*/	
	...
	/**
	* 
	* @function name 	: viewSalesReturnProduct()
	...
	*
	*/
	public function viewSalesReturnProduct($purchase_return_id) 
	{			
	...
	/**
	* 
	* @function name 	: getTotalAmountPurchaseReturn()
	* @description   	: get total no of purchase from database
	* @access 		 	: public
	* @return       	: int total no of records
	*
	*/
	public function getTotalAmountPurchaseReturn($data=array()) 
	{
            //$sql = "SELECT SUM(total) AS Amount FROM `purchase_return` WHERE manufacturer_id=".$this->session->userdata('manufacturer_user_id')." and order_status_id > '0'";


			$sql = "SELECT SUM(total) AS Amount FROM `purchase_return` WHERE manufacturer_id='".(int)$this->session->userdata('manufacturer_user_id')."'";

...
class Ticket_model extends CI_Model 
{
    ...
    */
    public function getTotalTickets($data = array()) 
    {
        ...
        $sql = "SELECT COUNT(*) AS total FROM ticket where 1=1 ";
         ...
         $sql .= "AND department_id = 6 and customer_id = ".(int)$this->session->userdata('manufacturer_user_id');       
    ...
    */
    public function GetAll()
    {
        ...
        $this->db->where('customer_id',$this->session->userdata('manufacturer_user_id'));
    ...
    */
    function reply()
    {
        ...
        $this->db->set('added_by',$this->session->userdata('manufacturer_user_id'));
        $this->db->set('added_by_role_id',$this->session->userdata('manufacturer_role_id'));	
    ...
    */
    function add_ticket()
    {
       ...
       $this->db->set('department_id',$this->session->userdata('manufacturer_role_id'));	
        $this->db->set('customer_id',$this->session->userdata('manufacturer_user_id'));
        $this->db->set('title',$this->input->post('Title'));
        $this->db->set('priority',$this->input->post('Priority'));
        $this->db->set('description',$this->input->post('Description'));
        $this->db->set('attachments',$imagearr);

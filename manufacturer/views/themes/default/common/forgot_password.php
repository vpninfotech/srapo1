        ...
        <div class="container-fluid bg-img animated fadeIn">
            <div class="row">
                ...
                <div class="col-lg-6 animated fadeInRight" id="register-form">
                    <div class="box-authentication custom-box-authentication forgot-form animated fadeInRight">
                    <form action="<?php echo base_url('common/forgot_password');?>" method="post" id="form_login" name="form_login">
                        <h3>Enter E-mail</h3>
                        <h5> Already Register?  <a href="<?php echo base_url('common/login');?>" >Login</a>  from here.</h5>
                          <div class="row">

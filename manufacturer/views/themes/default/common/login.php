                ...
                <div class="col-lg-6">
                    ...
                    <div class="intro-text">
                        ...
                        <span class="skills text-center">
                            ...
                            <img src="<?php echo HTTP_CATALOG.'assets/manufacturer/themes/'.$this->common->config('admin_theme');?>/img/banner.png">
                        </span>
                    </div>
                    </div>
                </div>
                <div class="col-lg-6 animated fadeInRight" id="register-form">
                    <div class="box-authentication custom-box-authentication login-form animated fadeInRight">
                     <form action="<?php echo base_url('common/login');?>" method="post" id="form_login" name="form_login">
                        <h3>Login Here</h3>
                        <h5> New user ?  <a href="<?php echo base_url('common/register');?>" > Register</a>  from here.</h5>
                        <div class="row">
                        ...
                        <div class="form-group">
                            <p class="forgot-pass"><a href="<?php echo base_url('common/forgot_password');?>" >Forgot your password?</a></p>
                        </div>
    ...
    <section class="faq animated fadeInRight" id="faq">
        <div class="container">
            ...
            <div class="row faq-content">
                <div class="col-lg-6">
                	<img src="<?php echo HTTP_CATALOG.'assets/manufacturer/themes/'.$this->common->config('admin_theme');?>/img/verify-user.png">
                ...
                <div class="col-lg-6">
                	<img src="<?php echo HTTP_CATALOG.'assets/manufacturer/themes/'.$this->common->config('admin_theme');?>/img/wait.png">
                	<h4>No Wait for customers and Orders</h4>
                    
                    <img src="<?php echo HTTP_CATALOG.'assets/manufacturer/themes/'.$this->common->config('admin_theme');?>/img/return.png">
        ...
        <div class="container">
            ...
            <div class="row registration">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="square">
                    	<img src="<?php echo HTTP_CATALOG.'assets/manufacturer/themes/'.$this->common->config('admin_theme');?>/img/user.png">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="square">
                    	<img src="<?php echo HTTP_CATALOG.'assets/manufacturer/themes/'.$this->common->config('admin_theme');?>/img/vat.png">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="square">
                    	<img src="<?php echo HTTP_CATALOG.'assets/manufacturer/themes/'.$this->common->config('admin_theme');?>/img/pan.png">
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="square">
                    	<img src="<?php echo HTTP_CATALOG.'assets/manufacturer/themes/'.$this->common->config('admin_theme');?>/img/bank.png">
        ...
        <div class="row">
            <div class="col-md-12 text-center">
                ...
                <div id="owl-demo">
                  ...
                  <div class="item"><img src="<?php echo HTTP_CATALOG.'assets/manufacturer/themes/'.$this->common->config('admin_theme');?>/img/mayloz.png" alt="Owl Image"></div>
                  <div class="item"><img src="<?php echo HTTP_CATALOG.'assets/manufacturer/themes/'.$this->common->config('admin_theme');?>/img/kabirking.png" alt="Owl Image"></div>
                  <div class="item"><img src="<?php echo HTTP_CATALOG.'assets/manufacturer/themes/'.$this->common->config('admin_theme');?>/img/maylozbiz.png" alt="Owl Image"></div>
                  <div class="item"><img src="<?php echo HTTP_CATALOG.'assets/manufacturer/themes/'.$this->common->config('admin_theme');?>/img/kanchan.png" alt="Owl Image"></div>
                  <div class="item"><img src="<?php echo HTTP_CATALOG.'assets/manufacturer/themes/'.$this->common->config('admin_theme');?>/img/mayloz.png" alt="Owl Image"></div>
                  <div class="item"><img src="<?php echo HTTP_CATALOG.'assets/manufacturer/themes/'.$this->common->config('admin_theme');?>/img/kabirking.png" alt="Owl Image"></div>
                  <div class="item"><img src="<?php echo HTTP_CATALOG.'assets/manufacturer/themes/'.$this->common->config('admin_theme');?>/img/maylozbiz.png" alt="Owl Image"></div>
                  <div class="item"><img src="<?php echo HTTP_CATALOG.'assets/manufacturer/themes/'.$this->common->config('admin_theme');?>/img/kanchan.png" alt="Owl Image"></div>
   	...
   	<section id="footer">
    	<div class="container">
        	<div id="introduce-box" class="row">
              ...
              <div class="col-md-3">
                <div id="address-box">
                    <a href="#"><img src="<?php echo HTTP_CATALOG.'assets/manufacturer/themes/'.$this->common->config('admin_theme');?>/img/logo.png" alt=""></a>
                    <!--<div id="address-list">

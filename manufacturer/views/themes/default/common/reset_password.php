        ...
        <div class="container-fluid bg-img animated fadeIn">
            <div class="row">
                ...
                <div class="col-lg-6 animated fadeInRight" id="register-form">
                    ...
                    <form action="<?php echo base_url('common/reset_password');?>" method="post" id="form_login" name="form_login">
                    <input type="hidden" name="manufacturer_id" value="<?php echo $user_id;?>">

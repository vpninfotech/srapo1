            ...
            <div class="box-body"> 
              ...
              <div class="nav-tabs-custom">
                  ...
                  <ul class="nav nav-tabs" id="order">
                    ...
                    <!--<li><a href="#tab-payments" data-toggle="tab">Payment Details</a></li>                    <li><a href="#tab-total" data-toggle="tab">Total</a></li>-->
                  </ul>
                          ...
                          <br>
                           ...
                           <div class="row">                               
										 ...
										 /* if(isset($taxes))
										  {
											  ...
											  {
											  ?>
                                              <option value="<?php echo $tax['tax_rate_id']; ?>"><?php echo $tax['name']; ?></option>
                                              <?php
											  }
										  }*/
										  ?>
                            ...
                            <div class="row">                               
                              <div class="col-md-6">
                                  <div class="form-group">
                                    <label for="payment_status" class="col-sm-3 control-label" style="text-align:left;">Payment Status</label>
                                    <div class="col-md-9">
                              ...
                              <div class="col-md-6">
                                  <div class="form-group">
                                    <label for="payment_method" class="col-sm-3 control-label" style="text-align:left;">Payment Method</label>
                                    <div class="col-md-9">
                            ...
                            <?php if ($this->session->userdata('role_id') == 1) { ?>
                                <!------- start : Select group ------>
                                <div class="form-group">
                                    <label class="control-label" for="user_status">Soft Deleted</label>
                                    <!--<div class="col-sm-9 col-md-10">-->
                          ...
                          <!--Start : button-->
                             <!-- <div class="form-group">
                                  ...
                                  <div class="col-sm-6 col-xs-6 text-right">
                                      <button id="button-purchase" name="button-purchase" class="btn btn-primary btnNext" type="button">
                    ...
                    <div class="tab-pane" id="tab-payments">
                        <!------- Start : input group ------> 
                        <div class="form-group">
                          <label class="col-sm-3 col-md-2 control-label" for="select_address">Select Address</label>
                          <div class="col-sm-9 col-md-10">
                      ...
                      <!------- Start : input group ------>
                      <div class="form-group required <?php if(form_error('payment_fname')!==""){echo "has-error";} ?>">
                        <label for="fname" class="col-sm-3 col-md-2 control-label"><span data-toggle="tooltip" title="">First Name</span></label>
                        <div class="col-sm-9 col-md-10">
                          <input type="text" id="payment_fname" name="payment_fname" class="form-control" placeholder="First Name" value="<?php echo set_value('payment_fname'); ?>">
                            <?php echo form_error('payment_fname','<div class="text-danger">', '</div>'); ?>
                        </div>
                      </div>
                      <!------- End : input group ------>
                      
                      <!------- Start : input group ------>
                      <div class="form-group required <?php if(form_error('payment_lname')!==""){echo "has-error";} ?>">
                        <label for="lname" class="col-sm-3 col-md-2 control-label"><span data-toggle="tooltip" title="">Last Name</span></label>
                        <div class="col-sm-9 col-md-10">
                          <input type="text" id="payment_lname" name="payment_lname" class="form-control" placeholder="Last Name" value="<?php echo set_value('payment_lname'); ?>">
                            <?php echo form_error('payment_lname','<div class="text-danger">', '</div>'); ?>
                        </div>
                      </div>
                      <!------- End : input group ------>
                      ...
                      <!------- Start : input group ------>
                      <div class="form-group">
                        <label for="company" class="col-sm-3 col-md-2 control-label"><span data-toggle="tooltip" title="">Company</span></label>
                        <div class="col-sm-9 col-md-10">
                          <input type="text" id="payment_company" name="payment_company" class="form-control" placeholder="Company Name">
                        </div>
                      </div>
                      <!------- End : input group ------>
                      
                      <!------- Start : input group ------>
                      <div class="form-group required <?php if(form_error('payment_add1')!==""){echo "has-error";} ?>">
                        <label for="add1" class="col-sm-3 col-md-2 control-label"><span data-toggle="tooltip" title="">Address 1</span></label>
                        <div class="col-sm-9 col-md-10">
                          <input type="text" id="payment_add1" name="payment_add1" class="form-control" placeholder="Address 1" value="<?php echo set_value('payment_add1'); ?>">
                            <?php echo form_error('payment_add1','<div class="text-danger">', '</div>'); ?>
                        </div>
                      </div>
                      <!------- End : input group ------>
                      ...
                      <!------- Start : input group ------>
                      <div class="form-group">
                        <label for="add2" class="col-sm-3 col-md-2 control-label"><span data-toggle="tooltip" title="">Address 2</span></label>
                        <div class="col-sm-9 col-md-10">
                          <input type="text" id="add2" name="add2" class="form-control" placeholder="Address 2">
                        </div>
                      </div>
                      <!------- End : input group ------>
                      
                      <!------- Start : input group ------> 
                      <div class="form-group required <?php if(form_error('payment_city')!==""){echo "has-error";} ?>">
                        <label class="col-sm-3 col-md-2 control-label" for="payment_city">City</label>
                        <div class="col-sm-9 col-md-10">
                          <select name="payment_city" id="payment_city" class="form-control">
                          <option value="" <?php echo  set_select('payment_city', '', TRUE); ?> >--- Please select City ---</option>
                            <option value="surat" <?php echo  set_select('payment_city', 'surat'); ?> >Surat</option>
                            <option value="vadodara" <?php echo  set_select('payment_city', 'vadodara'); ?> >Vadodara</option>
                            <option value="ahmedabad" <?php echo  set_select('payment_city', 'ahmedabad'); ?> >Ahmedabad</option>
                          </select>
                          <?php echo form_error('payment_city','<div class="text-danger">', '</div>'); ?>
                        </div>
                      </div>
                      <!------- End : input group ------>
                      ...
                      <!------- Start : input group ------>
                      <div class="form-group">
                        <label for="postcode" class="col-sm-3 col-md-2 control-label"><span data-toggle="tooltip" title="">Postcode</span></label>
                        <div class="col-sm-9 col-md-10">
                          <input type="text" id="payment_postcode" name="payment_postcode" class="form-control" placeholder="Postcode">
                        </div>
                      </div>
                      <!------- End : input group ------>
                      
                      <!------- Start : input group ------> 
                      <div class="form-group required <?php if(form_error('payment_country')!==""){echo "has-error";} ?>">
                        <label class="col-sm-3 col-md-2 control-label" for="payment_country">Country</label>
                        <div class="col-sm-9 col-md-10">
                          <select name="payment_country" id="payment_country" class="form-control">
                            <option value="" <?php echo  set_select('payment_country', '', TRUE); ?> >--- Please select Country ---</option>
                            <option value="india" <?php echo  set_select('payment_country', 'india'); ?> >India</option>
                            <option value="usa" <?php echo  set_select('payment_country', 'usa'); ?> >USA</option>
                            <option value="canada" <?php echo  set_select('payment_country', 'canada'); ?> >Canada</option>
                          </select>
                          <?php echo form_error('payment_country','<div class="text-danger">', '</div>'); ?>
                        </div>
                      </div>
                      <!------- End : input group ------>
                      
                      <!------- Start : input group ------> 
                      <div class="form-group required <?php if(form_error('payment_state')!==""){echo "has-error";} ?>">
                        <label class="col-sm-3 col-md-2 control-label" for="payment_state">Region State</label>
                        <div class="col-sm-9 col-md-10">
                          <select name="payment_state" id="payment_state" class="form-control">
                            <option value="" <?php echo  set_select('payment_state', '', TRUE); ?> >--- Please Select State---</option>
                            <option value="Gujarat" <?php echo  set_select('payment_state', 'Gujarat'); ?> >Gujarat</option>
                          </select>
                           <?php echo form_error('payment_state','<div class="text-danger">', '</div>'); ?>
                        </div>
                      </div>
                      <!------- End : input group ------>
                      ...
                      <div class="form-group">
                        <div class="col-sm-6 col-xs-6 text-left">
                          <button class="btn btn-default btnPrevious" name="back" type="button">
                          <i class="fa fa-arrow-left"></i>
                          Back
                          </button>
                        </div>
                        <div class="col-sm-6 col-xs-6 text-right">
                          <button id="button-payment-address" class="btn btn-primary btnNext" type="button">
                    ...
                    <div class="tab-pane" id="tab-total">
                      <!-- Start : product View cart table --> 
                        <div class="table-responsive table-padding">
                          <table class="table table-bordered table-hover table-padding" id="attribute">
                          <thead>
                              <tr>
                                <td class="text-left">Product</td>
                                <td class="text-left">Model</td>
                          ...
                          <tbody>
                              <tr id="attribute-row">
                                <td>Congenial Hot Pink Jacquard Designer Saree </td>
                                <td>M109 </td>
                              ...
                              <tr id="attribute-row">
                                ...
                                <td class="text-right"> $4,700.00 </td>
                              </tr>
                              <tr id="attribute-row">
                      ...
                      <!-- End : product View cart table -->
                      <legend>Order Details</legend>
                       <!------- Start : input group ------> 
                        <div class="form-group required <?php if(form_error('shipping_method')!==""){echo "has-error";} ?>">
                          <label class="col-sm-3 col-md-2 control-label" for="shipping_method">Shipping Method</label>
                          <div class="col-sm-9 col-md-10">
                          <div class="input-group">
                            <select name="shipping_method" id="shipping_method" class="form-control">
                            <option value="" <?php echo  set_select('shipping_method', '', TRUE); ?> >--- Please Select Shipping Method---</option>
                              <option value="dc" <?php echo  set_select('shipping_method', 'dc'); ?> >Euro</option>
                              <optgroup label="Weight Based Shipping">
                              <option value="india" <?php echo  set_select('shipping_method', 'india'); ?> >India 1  (Weight: 1.00kg) - Rs. 50.00</option>
                              </optgroup>
                              
                            </select>

                            <span class="input-group-btn">
                              <button id="shipping_method" class="btn btn-primary" type="button">Apply</button>
                            </span>
                          </div>
                            <?php echo form_error('shipping_method','<div class="text-danger">', '</div>'); ?>
                          </div>
                        </div>
                        <!------- End : input group ------>
                        ...
                        <!------- Start : input group ------> 
                        <div class="form-group">
                          <label class="col-sm-3 col-md-2 control-label" for="coupon">Coupon</label>
                          <div class="col-sm-9 col-md-10">
                          <div class="input-group">
                            <input type="text" id="coupon" name="coupon" class="form-control" placeholder="Coupon">
                            <span class="input-group-btn">
                              <button id="btn_coupon" class="btn btn-primary" type="button">Apply</button>
                            </span>
                          </div>
                          </div>
                        </div>
                        ...
                        <!------- Start : input group ------> 
                        <div class="form-group">
                          <label class="col-sm-3 col-md-2 control-label" for="voucher">Voucher</label>
                          <div class="col-sm-9 col-md-10">
                          <div class="input-group">
                            <input type="text" id="voucher" name="voucher" class="form-control" placeholder="Coupan">
                            <span class="input-group-btn">
                              <button id="voucher" class="btn btn-primary" type="button">Apply</button>
                            </span>
                          </div>
                          </div>
                        </div>
                        ...
                        <!------- Start : input group ------> 
                        <div class="form-group">
                          <label class="col-sm-3 col-md-2 control-label" for="reward">Reward</label>
                          <div class="col-sm-9 col-md-10">
                          <div class="input-group">
                            <input type="text" id="reward" name="reward" class="form-control" placeholder="Coupan">
                            <span class="input-group-btn">
                              <button id="voucher" class="btn btn-primary" type="button">Apply</button>
                            </span>
                          </div>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-sm-9 col-md-10">
                            <select name="order_status" id="order_status" class="form-control">
                              ...
                              <option value="cn">Canceled</option>
                            </select>
                          </div>
                        </div>
                        <!------- End : input group ------>
                        ...
                        <div class="form-group">
                          <label class="col-sm-3 col-md-2 control-label" for="comment">Comment</label>
                          <div class="col-sm-9 col-md-10">
...
$(document).ready(function() {
	...
	$.ajax({
		...
		success: function(json) {
			...
			$.each(json,function(index,value){
				...
				//order_list.push(value.order_id);
	...
	//console.log('id change:'+order_id);
	/*$.ajax({
		//url: "<?php //echo base_url()."purchase/purchase/getOrderProductListByOrderId"; ?>",
		...
		dataType: "json",
		success: function(json) {
			//console.log('order_product_id: '+JSON.stringify(json));				
			var html="";
			...
			$.each(json,function(index,value){
				//console.log(value.order_id);
				//html+="<option value='"+value.manufacturer_id+"'>"+value.firstname+"</option>";
				console.log('in manufacturer_id:'+manufacturer_id);
				if(manufacturer_id > 0)
				{
					if(value.manufacturer_id == manufacturer_id)
					{
						html+="<option value='"+value.manufacturer_id+"' selected='selected'>"+value.firstname+"</option>";
					}
					else
					{
						html+="<option value='"+value.manufacturer_id+"'>"+value.firstname+"</option>";
	...
	$('#select_order').change(function(){
		...
		$.ajax({
			...
			dataType: "json",
			success: function(json) {
				//console.log('manufacturer list: '+JSON.stringify(json));
	...
	$("#select_manufacturers").change(function(){
		...
		//console.log('select manufacturer_id:'+manufacturer_id);
		$.ajax({
			type:"POST",
	...
	$('#button-refresh').on('click', function() {
		...
		$.ajax({
			...
			success: function(json) {
				console.log(json);
				html = '';
				/*console.log('productid:'+$('#product_id').val());
	...
	jQuery(window).load(function () { 
		...
		//console.log($('#edit_keyword').val());
		if($('#edit_keyword').val() == 1)
		{
			//change trigger
			$("#select_manufacturers").trigger('change');
			//console.log($("#select_manufacturers").val());  	
		...
		//alert($("#select_manufacturers").val()); 
		/*if($('#select_order').val() != "" && $('#select_manufacturers').val() != "")
		{ 	
			// Refresh products and totals
			$('#button-refresh').trigger('click');			
		}*/
	...
	$('#button-purchase').click(function(){
		...
		/*var text = $('textarea#input-description').val();
		console.log('description:'+text+'||manufacturer_id:'+manufacturer_id);
		*/

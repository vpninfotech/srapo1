                            ...
                            <div class="row">
                                <div class="col-xs-12 col-sm-4 col-lg-3 left-column ">
                                    <div class="col-xs-10 col-sm-10 col-lg-10 title-left-column">
                                        <p style="font-size:large; margin-bottom: 9px">All Tickets</p>
                                                        ...
                                                        <ul class="timeline">
                                                            ...
                                                            <?php foreach($Ticket_info['Ticket_reply'] as $Ticket_note) :?>
                                                              ...
                                                              <li class="item-timeline post-form-timeline" style="width:100%" id="Ticket_note_<?php echo $Ticket_note['ticket_reply_id'];?>">
                                                                ...
                                                                <div class="inner-content custom-inner-content <?php if($Ticket_note['added_by'] == $this->session->userdata('manufacturer_user_id')) { echo 'User_Note'; }?>">
                                                                    ...
                                                                    <div class="row">
                                                                      ...
                                                                      <div class="col-xs-12 col-sm-4">
                                                                        <div class="pull-right">
                                                                          <?php if($Ticket_note['added_by'] == $this->session->userdata('manufacturer_user_id')) :?>

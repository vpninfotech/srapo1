...
class Db_log {
    ...
    function logQueries() {
        ...
        $filepath = APPPATH . 'logs/Query-log.php'; // Creating Query Log file with today's date in application/logs folder
        ...
        foreach ($CI->db->queries as $key => $query) { 
            $sql = $query . " \n Execution Time:" . $times[$key] . "\n UserID:" .$UserID . "\n Date&Time:" .date('Y-m-d H:i:s'); // Generating SQL file alongwith execution time

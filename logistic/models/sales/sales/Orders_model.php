...
//get order_product table data
	...
	{
		$sql="select distinct op.*,m.manufacturer_id,m.firstname,op.manufacturer_id from order_product op left join manufacturer m on op.manufacturer_id = m.manufacturer_id";

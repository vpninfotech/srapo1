    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
           <a href="#" class="small-box-footer">Today Orders : <?php echo $order['percentage']; ?>%</a>
            <div class="inner">
        ...
        <div class="col-lg-3 col-xs-6">
          <!-- small box -->
          <div class="small-box bg-green">
           <a href="#" class="small-box-footer">Today Purchase : <?php echo $purchase['percentage']; ?>%</a>
            <div class="inner">
              <h3><?php echo $purchase['total']; ?></h3>
            ...
            <a href="<?php echo base_url('purchase/purchase'); ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">

...
class Purchase_report extends CI_Controller {
	...
	function __construct()
	{
		...
		$this->load->model('reports/purchase_report_model','purchase_report');		
				
		$this->lang->load('reports/purchase_report_lang', 'english');
	...
	*/
	...
	private function _init() {
		...
		$this->output->set_common_meta('Purchase Report','sarpo','This is srapo purchase report page');
	}
	...
	*/
	...
	{   
            ...
            $this->data['breadcrumbs'][] = array(
               ...
               'href' => base_url('reports/purchase_report'),		 
            );
            
            
            $filter_array             = $this->session->userdata('purchase_filter_array');
            $filter_date_start        = "";
            $filter_date_end          = "";
            ...
            $total_records = $this->purchase_report->getTotalPurchase($data);
            ...
            $results = $this->purchase_report->getPurchase($data);
            ...
            $admin_theme = $this->common->config('admin_theme');
            $content_page="themes/".$admin_theme."/reports/purchase_report_list";
    ...
    public function search()
    {
        ...
        {			
           if ($this->input->post('filter_date_start') !== NULL) {
            ...
            $this->session->set_userdata('purchase_filter_array', $filter);
        }
        if ($this->input->post('button_all') !== NULL) 
        {
           $this->session->set_userdata('purchase_filter_array', array());
        }
        $this->index();           
    }

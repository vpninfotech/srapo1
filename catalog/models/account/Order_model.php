...
class Order_model extends CI_Model 
{
    ...
    */
    public function getTotalOrders() {
        $sql = "SELECT COUNT(*) AS total FROM `order` o WHERE customer_id = '".$this->session->userdata('customer_id')."'";
    ...
    */
    public function getOrders($data = array()) {
        ...
        $sql = "SELECT o.order_id, CONCAT(o.firstname, ' ', o.lastname) AS customer, (SELECT os.order_status_name FROM order_status os WHERE os.order_status_id = o.order_status_id ) AS status, o.shipping_code, o.total, o.currency_code,o.payment_method, o.currency_value,o.date_added, o.date_modified FROM `order` o WHERE o.customer_id = '".$this->session->userdata('customer_id')."'";
    ...
    /**
    * 
    * @function name 	: getTotalOrderProductsByOrderId()
    * @description   	: get total Product by order_id from database
    * @access 		: public
    * @param   		: string $order_id The Product that you want to get
    * @return       	: array The selected Order array
    *
    */
    ...
    /**
    * 
    * @function name 	: getTotalOrderVouchersByOrderId()
    * @description   	: get total Voucher by order_id from database
    * @access 		: public
    * @param   		: string $order_id The Voucher that you want to get
    * @return       	: array The selected Order array
    *
    */
    ...
    */
    ...
    public function getOrderProduct($order_id,$order_product_id) {
        $query = $this->db->query("SELECT * FROM order_product WHERE order_id = '" . (int)$order_id . "' AND order_product_id = '". (int)$order_product_id ."'");
    ...
    public function getOrderVouchersTheme($voucher_id) {
        $query = $this->db->query("SELECT image FROM voucher_theme WHERE voucher_theme_id = '" . (int)$voucher_id . "'");
	...
	*/
	...
	public function getTotalOrderHistories($order_id) {
        ...
        public function cancelOrder($cancelId) {
            $this->db->set('order_status_id',7);
            $this->db->where('order_id',$cancelId);

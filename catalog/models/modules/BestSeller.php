 ...
 */
class BestSeller extends CI_Model 
{
	/**
	* 
	...
	* @access 		 	: public
	* @param   		 	: void
	* @return       	: array The BestSeller
	*
	*/
	public function getBestSeller($category_id='') 
	{
		
		
		$data['products'] = array();
		
		$results = $this->product->getBestSellerProducts($this->common->config('config_bestseller_limit'),$category_id);

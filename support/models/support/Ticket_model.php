...
class Ticket_model extends CI_Model 
{
    ...
    */
	function edit_ticket_reply()
	{
		...
		$this->db->set('modified_by',$this->session->userdata('support_user_id'));	
    ...
    */
	function reply()
	{
		...
		$this->db->set('added_by',$this->session->userdata('support_user_id'));
		$this->db->set('added_by_role_id',$this->session->userdata('support_role_id'));	

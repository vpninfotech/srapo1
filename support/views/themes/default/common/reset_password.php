  ...
  <?php if(isset($error) && $error!==""): ?>
    ...
    <input type="hidden" name="user_id" value="<?php echo $user_id;?>">
      <div class="form-group has-feedback <?php if(form_error('pwd')!==""){echo "has-error";} ?>">
        <input type="password" name="pwd" class="form-control" placeholder="Password" value="<?php echo $pwd;?>">
      ...
      <div class="form-group has-feedback <?php if(form_error('cnfpwd')!==""){echo "has-error";} ?>">
        <input type="password" name="cnfpwd" class="form-control" placeholder="Confirm Password" value="<?php echo $cnfpwd;?>">
        <span class="glyphicon glyphicon-lock form-control-feedback"></span>

(function($){
    ...
    $(document).ready(function() {
        ...
        $('.slider-range-price').each(function(){
            ...
            $( this ).slider({
              ...
              slide: function( event, ui ) {
                ...
                t.closest('.slider-range').find('.slider-range-price').attr("data-min", ui.values[ 0 ]);
		t.closest('.slider-range').find('.slider-range-price').attr("data-max", ui.values[ 1 ]);
              }
            });
        })
        ...
        $(document).on('click','.display-product-option .view-as-grid',function(){
            ...
            $(this).parent().parent().parent().find('.product-list').removeClass('list').addClass('grid');
            return false;
        })
        ...
        $(document).on('click','.display-product-option .view-as-list',function(){
            $(this).closest('.display-product-option').find('li').removeClass('selected');
            $(this).addClass('selected');
            $(this).parent().parent().parent().find('.product-list').removeClass('grid').addClass('list');
            return false;
        })
        /// tre menu category
        ...
        $(document).on('click','.quick-view .search,a.quick-view',function(){
            ...
            $.post(baseurl+'/product/QuickView', data, function(response){
                $.fancybox(response, {
    ...
    $(window).scroll(function(){
        ...
        if(width > 767){
            if( h > (max_h + vertical_menu_height)-50){
				...
				/*$('#user-info-opntop #user-info-top').appendTo('.top-header .container'); changes by rajesh*/
                $('#user-info-opntop #user-info-top').appendTo('.top-header .container .support-link');
...
/*top-header menu adjust on media query*/

 if($(window).width()<332){
  $(".user-info").css("width", "auto");
  $('#user-info-top').addClass('pull-left');
 }
 
 /*  Start : Script for Bootstrap popup open in center of screen */
 ...
 /*Start : in responsive media my account option in  top-header option do not click some div*/
 $(document).scroll(function() {
  var y = $(this).scrollTop();
  if (y > 200) {
	 $('#user-info-opntop').css('display','block');
  } else {
	 $('#user-info-opntop').css('display','none');
  }
});

/* End : in responsive media my account option in  top-header option do not click some div*/
(function($){
    "use strict"; // Start of use strict
    /* ---------------------------------------------
     Scripts scroll

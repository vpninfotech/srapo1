...
/*                            results += '<a href="'+j.href+'" class="list-group-item" data-id="'+j.id+'" data-label="'+j.lable+'"><img src="'+j.icon+'" />'+j.lable+'<span>'+j.price+'</span></a>';*/
						     results += '<a href="'+j.href+'" class="list-group-item" data-id="'+j.id+'" data-label="'+j.lable+'" style="color:#EE0E5C;font-weight:bold"><img src="'+j.icon+'" />'+j.lable+'</a>';	
                        });
        ...
        function selectResult(){
           //console.log($(this).context);
			window.location = $(this).context.getAttribute('href');
            if (settings.idField) {

 <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper"> 
    ...
    <section class="content-header">
      <h1>Shipping Methods<small></small> </h1>
     <ul class="breadcrumb">
          ...
          <div class="box-body">
            ...
            <table id="theme-table" class="table table-bordered table-hover">
              ...
              <?php if(isset($records)){ //echo "<pre>"; print_r($records); echo "</pre>";?>
                ...
                <tr class="">
                <td class="col-xs-3 col-md-3"><?php echo $row['shipping_method_name']; ?></td>
                    
                    
                    <td class="col-xs-3 col-md-3" style="width:10%">
                       <?php if(($this->common->config($row['shipping_code'].'_status'))=='1') { ?>

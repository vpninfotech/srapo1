<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper"> 
    ...
    <section class="content-header">
      <h1>Purchase Return<small></small> </h1>
      <ul class="breadcrumb">
			  ...
			  <?php if(isset($records)){
                ...
                ?>
              	<tr class="<?php //if(($row['is_deleted'] == 1)) { echo "bg-danger"; } ?>">
                    ...
                    <td class="col-sm-3"><?php echo $row['return_reason_name']; ?><input type="hidden" name="return_reason_id" id="return_reason_id" value="<?php echo $row['return_reason_id']; ?>" /></td>

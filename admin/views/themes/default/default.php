      ...
      <div class="navbar-inner">
        <div class="container">
          ...
          <div style="height: 0px;" class="nav-collapse collapse">
            <ul class="nav">
              <li class="active"><a href="<?php echo site_url('common/example/'); ?>">Home</a></li>
			  <li><a href="<?php echo site_url('common/example/example_1'); ?>">Example 1</a></li>
              <li><a href="<?php echo site_url('common/example/example_2'); ?>">Example 2</a></li>
              <li><a href="<?php echo site_url('common/example/example_3'); ?>">Example 3</a></li>
              <li><a href="<?php echo site_url('common/example/example_4'); ?>">Example 4</a></li>
            </ul>
          </div><!--/.nav-collapse -->
        </div>
      </div>

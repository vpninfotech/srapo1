                                                        ...
                                                        <ul class="timeline">
                                                            ...
                                                            <?php foreach($Ticket_info['Ticket_reply'] as $Ticket_note) :?>
                                                              <li class="item-timeline post-form-timeline" style="width:100%" id="Ticket_note_<?php echo $Ticket_note['ticket_reply_id'];?>">
                                                                ...
                                                                <div class="inner-content custom-inner-content <?php if($Ticket_note['added_by'] == $this->session->userdata('user_id')) { echo 'User_Note'; }?>">
                                                                    ...
                                                                    <div class="row">
                                                                      ...
                                                                      <div class="col-xs-12 col-sm-4">
                                                                        <div class="pull-right">
                                                                          <?php if($Ticket_note['added_by'] == $this->session->userdata('user_id')) :?>

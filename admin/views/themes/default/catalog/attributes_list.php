            ...
            <thead>
              <tr>
                ...
                <th class="<?php if ($sort_by == 'attribute_name') echo "sort_$sort_order";?>"><a href="<?php echo base_url('catalog/attributes/index/attribute_name/'.(($sort_order == 'ASC') ? 'DESC' : 'ASC').'/'.$this->uri->segment(6)); ?>">Attribute Name</a></th>
                 <th class="<?php if ($sort_by == 'attribute_group') echo "sort_$sort_order";?>"><a href="<?php echo base_url('catalog/attributes/index/attribute_group/'.(($sort_order == 'ASC') ? 'DESC' : 'ASC').'/'.$this->uri->segment(6)); ?>">Attribute Group</a></th>

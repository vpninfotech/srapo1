            ...
            <table class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <th class="<?php if ($sort_by == 'category_name') echo "sort_$sort_order";?>"><a href="<?php echo base_url('catalog/category/index/category_name/'.(($sort_order == 'ASC' && $sort_by == 'category_name') ? 'DESC' : 'ASC').'/'.$this->uri->segment(6)); ?>">Category Name</a></th>
                   <th class="text-right <?php if ($sort_by == 'sort_order') echo "sort_$sort_order";?>"><a href="<?php echo base_url('catalog/category/index/sort_order/'.(($sort_order == 'ASC' && $sort_by == 'sort_order') ? 'DESC' : 'ASC').'/'.$this->uri->segment(6)); ?>">Sort Order</a></th>

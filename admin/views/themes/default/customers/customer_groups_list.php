<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper"> 
    ...
    <section class="content-header">
      <h1>Customer Groups<small></small> </h1>
       <ul class="breadcrumb">
      ...
      <div class="col-xs-12">
              ...
              <thead>
                <tr>
                  <th class="col-xs-1">
                    ...
                    <th class="<?php if ($sort_by == 'group_name') echo "sort_$sort_order";?>"><a href="<?php echo base_url('customers/customer_groups/index/group_name/'.(($sort_order == 'ASC') ? 'DESC' : 'ASC').'/'.$this->uri->segment(6)); ?>">Customer Group Name</a></th>
		...
		<?php if(isset($records)) { ?>	 
                <?php foreach($records as $row){?>
                  ...
                  <td><?php if (in_array($row['customer_group_id'], $selected)) { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $row['customer_group_id']; ?>" checked="checked" />
                    <?php } else { ?>
                    <input type="checkbox" name="selected[]" value="<?php echo $row['customer_group_id']; ?>" />
                    <?php } ?></td>

      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            <h2 class="box-title col-sm-6"> <i class="fa fa-list"></i> User Group </h2>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
              ...
              <table id="theme-table" class="table table-bordered table-hover">
                <thead>
                  <tr>
                    ...
                    <th class="<?php if ($sort_by == 'role_name') echo "sort_$sort_order";?>"><a href="<?php echo base_url('system/user_groups/index/role_name/'.(($sort_order == 'ASC') ? 'DESC' : 'ASC').'/'.$this->uri->segment(6)); ?>">User Group Name</a></th>
                ...
                <tbody>
                  ...
                  <tr class="<?php if(($row['is_deleted'] == 1)) { echo "bg-danger"; } ?>">
                    <td><?php if (in_array($row['role_id'], $selected)) { ?>
                      <input type="checkbox" name="selected[]" value="<?php echo $row['role_id']; ?>" checked="checked" />
                      <?php } else { ?>
                      <input type="checkbox" name="selected[]" value="<?php echo $row['role_id']; ?>" />
                      <?php } ?></td>

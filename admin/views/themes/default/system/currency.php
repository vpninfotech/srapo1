  ...
  <div class="content-wrapper"> 
    ...
    <section class="content-header">
     ...
     <div class="pull-right">
                 <button class="btn btn-primary" type="submit" value="save" name="currency_save" form="form-currency"><i class="fa fa-save"></i></button>
    ...
    <section class="content">
     <form class="form-horizontal" action="<?php echo $form_action ?>" method="post" name="currency_form" id="form-currency">
          ...
          <div class="box box-default">
            ...
            <div class="box-body"> 
              ...
              <div class="form-group required <?php if(form_error('title')!==""){echo "has-error";} ?>">
                <label for="currency_title" class="col-sm-3 col-md-2 control-label">Currency Title</label>
                <div class="col-sm-9 col-md-10">
                    <input type="text" name="title" id="currency_title" class="form-control" placeholder="Currency Title" value="<?php echo $title; ?>">
              ...
              <div class="form-group required <?php if(form_error('code')!==""){echo "has-error";} ?>">
                <label for="code" class="col-sm-3 col-md-2 control-label"><span class="trigger"  data-html="true" data-trigger="click" title="" data-original-title='Do not change if this is your default currency. Must be valid <a href="http://www.xe.com/iso4217.php" target="_blank">ISO code</a>.'>Code</span></label>
                <div class="col-sm-9 col-md-10">
              ...
              <div class="form-group">
                <label for="symbol_left" class="col-sm-3 col-md-2 control-label">Symbol Left</label>
                <div class="col-sm-9 col-md-10">
                  <input type="text" class="form-control" name="symbol_left" id="symbol_left" placeholder="Symbol Left" value="<?php echo $symbol_left; ?>" >
                </div>
              </div>
              <!------- end : input group ------>
              ...
              <!------- start : input group ------>
              <div class="form-group">
                <label for="symbol_right" class="col-sm-3 col-md-2 control-label">Symbol Right</label>
                <div class="col-sm-9 col-md-10">
                  <input type="text" class="form-control" name="symbol_right" id="symbol_right" placeholder="Symbol Right" value="<?php echo $symbol_right; ?>">
                </div>
              </div>
              <!------- end : input group ------>
              ...
              <!------- start : input group ------>
              <div class="form-group">
                <label for="decimal_places" class="col-sm-3 col-md-2 control-label">Decimal Places</label>
                <div class="col-sm-9 col-md-10">
                  <input type="text" class="form-control" name="decimal_place" id="decimal_places" placeholder="Decimal Places" value="<?php echo $decimal_place; ?>">
                </div>
              </div>
              <!------- end : input group ------>

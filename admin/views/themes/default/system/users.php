          ...
          <div class="box-body">
            <form class="form-horizontal" action="<?php echo $form_action ?>" method="post" name="form-users" id="form-users">
              ...
              <div class="form-group">
                <label class="col-sm-3 col-md-2 control-label" for="status">User Group</label>
                <div class="col-sm-9 col-md-10">
                  <select name="user_group_id" id="user_group_id" class="form-control">
                    <?php foreach ($user_groups as $user_group) { ?>
                    <?php if ($user_group['role_id'] == $user_group_id) { ?>
                    <option value="<?php echo $user_group['role_id']; ?>" selected="selected"><?php echo $user_group['role_name']; ?></option>
                    <?php } else { ?>
                    <option value="<?php echo $user_group['role_id']; ?>"><?php echo $user_group['role_name']; ?></option>
                    <?php } ?>
                    <?php } ?>
                  </select>
                </div>
              ...
              <!------- start : input group ------>
              <div class="form-group <?php if(form_error('confirm_pwd')!=="" ){echo "has-error";} ?>">

            ...
            <input type="hidden" name="tax_class_id" value="<?php echo $tax_class_id; ?>" />
              ...
              <tr id="tax-rule-row<?php echo $tax_rule_row; ?>">
                ...
                <td class="text-left"><select name="tax_rule[<?php echo $tax_rule_row; ?>][based]" class="form-control">
                    ...
                    <option value="shipping" selected="selected"><?php echo 'Shipping Address'; ?></option>
                    <?php } else { ?>
                    <option value="shipping"><?php  echo 'Shipping Address'; ?></option>
                    <?php } ?>
                    <?php  if ($tax_rule['based'] == 'payment') { ?>
                    <option value="payment" selected="selected"><?php echo 'Payment Address'; ?></option>
                    <?php } else { ?>
                    <option value="payment"><?php echo 'Payment Address'; ?></option>
                    <?php } ?> 
                    <?php  if ($tax_rule['based'] == 'store') { ?>
                    <option value="store" selected="selected"><?php echo 'Store Address'; ?></option>
                    <?php } else { ?>
                    <option value="store"><?php echo 'Store Address'; ?></option>
                    <?php } ?>    
...
function addRule() {
    ...
    html += '    <option value="shipping"><?php echo 'shipping Address'; ?></option>';
    html += '    <option value="payment"><?php echo 'payment Address'; ?></option>'; 
	html += '    <option value="store"><?php echo 'Store Address'; ?></option>';
    html += '  </select></td>';

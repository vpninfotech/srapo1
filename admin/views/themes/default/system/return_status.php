  ...
  <div class="content-wrapper"> 
    ...
    <section class="content-header">
     ...
     <div class="pull-right">
                 <button class="btn btn-primary" type="submit" value="save" name="Return_status_save" form="form-Return_status"><i class="fa fa-save"></i></button>
      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="box box-default">
            ...
            <div class="box-body"> 
           <form class="form-horizontal" action="<?php echo $form_action ?>" method="post" name="Return_status_form" id="form-Return_status">
    <input type="hidden" name="token" id="token" value="<?php echo $this->session->userdata('token'); ?>" />
              
             
              <input type="hidden" name="return_status_id" value="<?php echo $return_status_id; ?>" />
              <!-- Start : input Group -->
              <div class="form-group required <?php if(form_error('return_status_name')!==""){echo "has-error";} ?>">
                <label for="return_status_name" class="col-sm-3 col-md-2 control-label">Return Status Name</label>
                <div class="col-sm-9 col-md-10">
                    <input type="text" name="return_status_name" id="return_status_name" class="form-control" placeholder="Return Status Name" value="<?php echo $return_status_name; ?>">
                    <?php echo form_error('return_status_name','<div class="text-danger">', '</div>'); ?>
                </div>
              </div>
              <!-- End : input Group -->

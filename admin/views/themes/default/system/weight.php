  ...
  <div class="content-wrapper"> 
    ...
    <section class="content-header">
     ...
     <div class="pull-right">
                 <button class="btn btn-primary" type="submit" value="save" name="weight_save" form="form-weight"><i class="fa fa-save"></i></button>
    ...
    <section class="content">
     <form class="form-horizontal" action="<?php echo $form_action ?>" method="post" name="weight_form" id="form-weight">
          ...
          <div class="box box-default">
            ...
            <div class="box-body"> 
              ...
              <div class="form-group required <?php if(form_error('title')!==""){echo "has-error";} ?>">
                <label for="weight_title" class="col-sm-3 col-md-2 control-label">Weight Title</label>
                <div class="col-sm-9 col-md-10">
                    <input type="text" name="title" id="weight_title" class="form-control" placeholder="Weight Title" value="<?php echo $title; ?>">
              ...
              <div class="form-group required <?php if(form_error('unit')!==""){echo "has-error";} ?>">
                <label for="unit" class="col-sm-3 col-md-2 control-label"><span class="trigger"  data-html="true" data-trigger="click" title="" data-original-title='Do not change if this is your default weight.'>Unit</span></label>
                <div class="col-sm-9 col-md-10">

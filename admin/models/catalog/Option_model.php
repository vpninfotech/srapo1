...
class Option_model extends CI_Model 
{
	...
	*/
	...
	{
            $sql = "SELECT * FROM `option` WHERE 1=1";
	...
	*/
	...
	public function getOptionValue($option_value_id) {
		$query = $this->db->query("SELECT * FROM option_value ov  WHERE ov.option_value_id = '" . (int)$option_value_id . "'");

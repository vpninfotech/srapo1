...
class Downloads extends CI_Controller {
				...
				else
				{
					$url .= '/0';
                                ...
                                if ($this->input->post('is_deleted') == 1) {
                                    $res = $this->validateSoftDelete($this->input->post('download_id'));
                                    if($res==0)
                                    {
                                        $this->session->set_userdata('error',$this->error['warning']);
                                        redirect('catalog/downloads/edit'.$url.'/'.$this->commons->encode($this->input->post('download_id')));  
                                    }
                                } 
	...
	*
	*/
	public function validateSoftDelete($download_id) 
	{		

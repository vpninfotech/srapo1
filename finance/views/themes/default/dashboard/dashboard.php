    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
           <a href="#" class="small-box-footer">Today Purchase : <?php //echo $order['percentage']; ?>%</a>
            <div class="inner">
            ...
            <a href="<?php //echo base_url('sales/orders'); ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          <!-- small box -->
          <div class="small-box bg-green">
           <a href="#" class="small-box-footer">Today Sales : <?php echo $sales['percentage']; ?>%</a>
            <div class="inner">
        ...
        <div class="col-lg-3 col-xs-6">
          <!-- small box -->
          <div class="small-box bg-green">
           <a href="#" class="small-box-footer">Today Income : <?php //echo $customers['percentage']; ?>%</a>
            <div class="inner">
            ...
            <a href="<?php //echo base_url('customers/customer'); ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
          </div>
        </div>
        <!-- ./col -->
        <div class="col-lg-3 col-xs-6">
          <!-- small box -->
          <div class="small-box bg-green">
           <a href="#" class="small-box-footer">Today Expense : <?php //echo $tickets['percentage']; ?>%</a>
            <div class="inner">
                ...
                <div class="col-md-6">
                    <div class="box box-primary">
                        <div class="box-header">
                            <h3 class="box-title"><i class="fa fa-eye"></i>World Map</h3>
                        </div>
                        <div class="box-body">

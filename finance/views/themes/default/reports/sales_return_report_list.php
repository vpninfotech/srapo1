...
<div class="content-wrapper"> 
    ...
    <section class="content-header">
        <h1>Returns Report<small></small> </h1>
        <ul class="breadcrumb">
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        ...
                        <div class="well well-sm sales_report">
                            <div class="row">
                                <form action="<?php echo base_url("reports/sales_return_report/search"); ?>" method="post">
                                    <!-- start : left column -->
                                    <div class="col-sm-6"> 
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12 input-padding">
                                                <select name="filter_groups" id="filter_groups" class="form-control">
                                                ...
                                                <script>
                                                    $("#filter_groups").val(<?php echo $filter_groups; ?>);
                                                </script> 
                                            </div>
                                        </div>
                                        <!------ End : Date Picker Group ------> 
                                        ...
                                        <!-- Start : Date Picker Group -->
                                        <div class="form-group">
                                            <label for="filter_return_status_id" class="col-sm-12 control-label">Return Status</label>
                                            <div class="col-sm-12 input-padding">
                                                <select name="filter_return_status_id" id="filter_return_status_id" class="form-control">
                                                    <option value="0">All Statuses</option>
                                                    <?php foreach ($return_statuses as $return_status) { ?>

                                                        <?php if ($return_status['return_status_id'] == $filter_return_status_id) { ?>
                                                            <option value="<?php echo $return_status['return_status_id']; ?>" selected="selected"><?php echo $return_status['return_status_name']; ?></option>
                                                        <?php } else { ?>
                                                ...
                                                <script>
                                                    $("#filter_return_status_id").val(<?php echo $filter_return_status_id; ?>);
                                                </script> 
                                            </div>
                                        </div>
                                        <!------ End : Date Picker Group ------> 
                        ...
                        <table id="theme-table" class="table table-bordered table-striped">
                            <thead>
                                <tr>
                                    <th>Date Start</th>
                                    <th>Date End</th>
                                    <th class="text-right">No. Returns</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php if (isset($records)) { ?>
                                    <?php foreach ($records as $row) { ?>
                                        <tr>
                                            ...
                                            <td class="text-right"><?php echo $row['returns']; ?></td>
                                        </tr>
                                    <?php } ?>
                                <?php } else { ?>
                                    <tr>

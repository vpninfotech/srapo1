                                ...
                                <div class="nav-tabs-custom">
                                    ...
                                    <div class="tab-content"> 
                                        ...
                                        <div class="tab-pane" id="tab-data"> 
                                            ...
                                            <!------- End : image group ------>
                                            <!------- start : input group ------>
                                            <div class="form-group required <?php if (form_error('catalog_no') !== "") {
                                                        echo "has-error";
                                                    } ?>">
...
<?php echo form_error('catalog_no', '<div class="text-danger">', '</div>'); ?> 
                                            ...
                                            <!------- End : input group ------> 
                                            <!------- Start : input group ------>
                                            <div class="form-group required <?php if (form_error('is_front') !== "") {
    echo "has-error";
} ?>">
                                                ...
                                                <div class="col-sm-9 col-md-10">
                                                    <select name="is_front" id="is_front" class="form-control">
...
<?php echo form_error('model', '<div class="text-danger">', '</div>'); ?> 
                                            ...
                                            <!------- start : input group ------>
                                            <div class="form-group required <?php if (form_error('manufacturer_price') !== "") {
    echo "has-error";
} ?>">
                                            ...
                                            <!------- End : input group ------>
                                            <!------- start : input group ------>
                                            <div class="form-group <?php if (form_error('price') !== "") {
                                                        echo "has-error";
                                                    } ?>">
                                            ...
                                            <!------- start : input group ------>
                                            <div class="form-group <?php if (form_error('qty') !== "") {
                                                            echo "has-error";
                                                        } ?> ">
...
<?php echo form_error('qty', '<div class="text-danger">', '</div>'); ?>
                                            ...
                                            <!------- start : input group ------>
                                            <div class="form-group <?php if (form_error('m_qty') !== "") {
    echo "has-error";
} ?> ">
...
<?php } ?>
                                            ...
                                            <!------- start : input group ------>
                                            <div class="form-group <?php if (form_error('shipping') !== "") {
                                                            echo "has-error";
                                                        } ?>">
...
<?php echo form_error('shipping', '<div class="text-danger">', '</div>'); ?>
                                            ...
                                            <!------- start : input group ------>
                                            <div class="form-group <?php if (form_error('length') !== "" || form_error('width') !== "" || form_error('height') !== "") {
    echo "has-error";
} ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9 col-md-10">
                                                    <select id="length_class" name="length_class" class="form-control">
                                                        <option value="centimeter" <?php
if ($length_class === "centimeter") {
    echo 'selected';
}
?>>Centimeter</option>
                                                        <option value="millimeter" <?php
                                                        if ($length_class === "millimeter") {
                                                            echo 'selected';
                                                        }
                                                        ?>>Millimeter</option>
                                                        <option value="inch" <?php
                                                        if ($length_class === "inch") {
                                                            echo 'selected';
                                                        }
                                                        ?>>Inch</option>
                                                    </select>
                                            ...
                                            <!------- start : input group ------>
                                            <div class="form-group <?php if (form_error('weight') !== "") {
                                                                    echo "has-error";
                                                                } ?>">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-9 col-md-10">
                                                    <select name="weight_class" id="weight_class" class="form-control">
                                                        ...
                                                        if ($weight_class === "kilogram") {
                                                            echo 'selected';
                                                        }
                                                        ?>>Kilogram</option>
                                                        <option value="gram" <?php
                                                        if ($weight_class === "gram") {
                                                            echo 'selected';
                                                        }
                                                        ?>>Gram</option>
                                                        <option value="pound" <?php
                                                        if ($weight_class === "pound") {
                                                            echo 'selected';
                                                        }
                                                        ?>>Pound</option>
    ...
    <?php if ($product_option['type'] == 'time') { ?>
            ...
            <?php } ?>
                                                                                        ...
                                                                                        <td class="text-left"><button type="button" onclick="$(this).tooltip('destroy');
                                                                                                $('#option-value-row<?php echo $option_value_row; ?>').remove();" data-toggle="tooltip" title="" class="btn btn-danger"><i class="fa fa-minus-circle"></i></button></td>
                                                                                    </tr>

...
class Information_model extends CI_Model 
{
	...
	*/
    ...
    {
    	$query = $this->db->query("SELECT DISTINCT *, (SELECT keyword FROM url_alias WHERE query = 'information_id=" . (int)$information_id . "') AS seo_keywords FROM information  WHERE information_id = '" . (int)$information_id . "'");
	...
	*/
	public function addInformation()
	{
		...
		$this->db->set('bottom',$bottom);
                $this->db->set('column',$this->input->post('column'));
		...
		$information_id = $this->db->insert_id();
		  ...
		  if ($this->input->post('seo_keywords') !=="" && $information_id) 
        {
			$this->db->query("INSERT INTO url_alias SET query = 'information_id=" . (int)$information_id . "', keyword = '" . $this->input->post('seo_keywords') . "'");
		}
	...
	*/
	public function editInformation()
	{
		...
		$this->db->where('information_id',(int)$this->input->post('information_id'));
		 ...
		 $information_id = (int)$this->input->post('information_id');

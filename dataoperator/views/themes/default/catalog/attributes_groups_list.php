            ...
            <table id="theme-table" class="table table-bordered table-hover">
              <thead>
                <tr>
                  ...
                  <th class="<?php if ($sort_by == 'sort_order') echo "sort_$sort_order";?> text-right"><a href="<?php echo base_url('catalog/attributes_groups/index/sort_order/'.(($sort_order == 'DESC' ) ? 'ASC' : 'DESC').'/'.$this->uri->segment(6)); ?>">Sort Order</a></th>
